// src/components/copilot/MarkdownText.tsx
//
// Ported from the assistant-ui starter's `markdown-text.tsx`. Renders assistant
// text parts as GFM markdown with copy-able code blocks. `dot.css` is plain CSS
// (keyframes + :where() selectors) so it is safe under this project's Tailwind
// v3 PostCSS pipeline — no @assistant-ui/styles / Tailwind v4 CSS is pulled in.
